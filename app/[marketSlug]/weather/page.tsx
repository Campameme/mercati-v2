    ...
    <div className="container mx-auto px-4 md:px-6 py-10 md:py-14 max-w-5xl">
      ...
      {!weather ? (
        ...
        <>
          ...
          <div className="bg-white border-2 border-ink/10 rounded-xl p-6 mb-6">
          ...
          <div className="bg-white border-2 border-ink/10 rounded-xl p-6 mb-6">
            <p className="font-alt text-xs font-semibold uppercase tracking-[0.14em] text-ink-muted mb-3">Prossime ore</p>
          ...
          <div className="bg-white border-2 border-ink/10 rounded-xl p-6">
            <p className="font-alt text-xs font-semibold uppercase tracking-[0.14em] text-ink-muted mb-3">Prossimi giorni</p>
            <div className="space-y-2">
              {weather.daily.map((d, i) => (
                <div key={i} className="flex items-center justify-between py-2 border-b-2 border-ink/10 last:border-0">
