...
export default function NotFound() {
  return (
    <div className="min-h-[70vh] bg-paper bg-paper-grain flex items-center justify-center px-4">
      <div className="max-w-lg text-center py-20">
        <p className="font-alt text-xs font-semibold uppercase tracking-[0.18em] text-sole-600">
          Errore 404
        </p>
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <Link
            href="/"
            className="px-6 py-3 bg-ink text-paper rounded-full font-alt text-sm font-semibold hover:bg-mare transition-colors"
          >
            Torna alla home
          </Link>
          <Link
