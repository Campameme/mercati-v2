...
export default function Loading() {
  return (
    <div className="min-h-[100svh] bg-notte flex items-center justify-center">
      <div className="flex flex-col items-center gap-4 text-carta/85">
        <LogoMark className="w-16 h-12 text-carta" />
        <span className="font-alt font-semibold uppercase tracking-[0.06em] text-sm text-center leading-snug">
          Mercati della
          <br />
          Riviera di Ponente
        </span>
