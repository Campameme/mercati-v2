...
const PHOTOS: Record<string, CuratedPhoto> = {
  ...
  // — Archivio del progetto (foto fornite dal proprietario; licenza da
  //   confermare prima del lancio pubblico, vedi nota in docs) —
  'vita-mercato-lungomare': {
    src: '/zone/vita-mercato-lungomare.webp',
    alt: 'Il mercato settimanale sul lungomare, tra i banchi e le palme',
    file: 'ventimiglia-shopping-1024x682.webp',
    artist: 'Archivio del progetto',
    license: 'Da confermare',
    url: '',
  },
  'vita-mercato-sanremo-banchi': {
    src: '/zone/vita-mercato-sanremo-banchi.webp',
    alt: 'I banchi del mercato di Sanremo, pieni di gente sotto i tendoni',
    file: 'copy-of-sp_127108887.webp',
    artist: 'Archivio del progetto',
    license: 'Da confermare',
    url: '',
  },
  'vita-mercato-ventimiglia-borgo': {
    src: '/zone/vita-mercato-ventimiglia-borgo.webp',
    alt: 'Il mercato ai piedi della città vecchia di Ventimiglia',
    file: 'marche-vintimille-produits-italiens.jpg',
    artist: 'Archivio del progetto',
    license: 'Da confermare',
    url: '',
  },
  'vita-banchi-piazza': {
    src: '/zone/vita-banchi-piazza.webp',
    alt: 'I banchi del mercato stretti tra le case della piazza',
    file: 'Markt5-1536x1024.jpg',
    artist: 'Archivio del progetto',
    license: 'Da confermare',
    url: '',
  },
  'vita-antiquariato-piazza': {
    src: '/zone/vita-antiquariato-piazza.webp',
    alt: 'Il mercatino dell’antiquariato in piazza, tra i tavoli e la gente',
    file: '610685442_902951158926514.jpg',
    artist: 'Archivio del progetto',
    license: 'Da confermare',
    url: '',
  },
  'vita-antiquariato-banco': {
    src: '/zone/vita-antiquariato-banco.webp',
    alt: 'Ottoni, cornici e tazzine su un banco d’antiquariato',
    file: 'antiquariato.jpg',
    artist: 'Archivio del progetto',
    license: 'Da confermare',
    url: '',
  },
  'vita-antiquariato-cornici': {
    src: '/zone/vita-antiquariato-cornici.webp',
    alt: 'Cornici dorate accatastate al banco del rigattiere',
    file: 'mercato-antiquariato-1.jpg',
    artist: 'Archivio del progetto',
    license: 'Da confermare',
    url: '',
  },
  'vita-artigianato-borse': {
    src: '/zone/vita-artigianato-borse.webp',
    alt: 'Borse e ceste artigianali appese ai banchi, sotto l’ulivo',
    file: 'caption.jpg',
    artist: 'Archivio del progetto',
    license: 'Da confermare',
    url: '',
  },
  'vita-banco-ortofrutta-ombrelloni': {
    src: '/zone/vita-banco-ortofrutta-ombrelloni.webp',
    alt: 'Pomodori e carciofi sui banchi, sotto gli ombrelloni verdi',
    file: 'didier-provost-v8IbdsPXo7U-unsplash.jpg',
    artist: 'Didier Provost',
    license: 'Unsplash License',
    url: 'https://unsplash.com/photos/v8IbdsPXo7U',
  },
}
