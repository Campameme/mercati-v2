...
export const HOME_COPY: Record<Lang, HomeCopy> = {
  it: {
    ...
    operatorsLead: 'Il mercato non è un posto: è chi ci sta dietro. Banchi che hanno un nome, una faccia e una parola che vale. Qui li trovi prima di arrivarci — cosa vendono, dove sono, che giorno ci sono.',
  ...
  fr: {
    ...
    operatorsLead: 'Le marché n’est pas un lieu : c’est qui se tient derrière. Des étals qui ont un nom, un visage et une parole qui compte. Ici tu les trouves avant d’y aller — ce qu’ils vendent, où ils sont, quel jour.',
  ...
  de: {
    ...
    operatorsLead: 'Der Markt ist kein Ort: er ist, wer dahintersteht. Stände mit Namen, Gesicht und einem Wort, das gilt. Hier findest du sie, bevor du hingehst — was sie verkaufen, wo sie stehen, an welchem Tag.',
  ...
  en: {
    ...
    operatorsLead: 'The market isn’t a place: it’s who stands behind it. Stalls with a name, a face and a word you can count on. Here you find them before you go — what they sell, where they are, which day.',
