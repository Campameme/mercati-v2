...
export const INSTRUCTIONS_ROWS: string[][] = [
  ['Mercati della Riviera di Ponente — Import/Export Operatori'],
  [''],
  ...
  ['PlaceId', 'UUID del luogo fisico (place). Informativo: indica quali sessioni condividono lo stesso luogo (e quindi la stessa area sulla mappa). Non viene usato in import: la chiave resta ScheduleId.'],
